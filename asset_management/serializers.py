...
class AssetSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Asset
        fields = ['id', 'host', 'first_seen', 'last_seen', 'info_count', 'vuln_count', 'tags']
...
class AssetDetailSerializer(AssetSerializer):
    ...
    def get_notes(self, obj):
        ...
        if hasattr(obj, 'notes'):
            return [{'id': note.id, 'content': note.content, 'created_at': note.created_at} for note in obj.notes.all()]
        return []
