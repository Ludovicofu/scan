...
const assetAPI = {
  ...
  // 创建资产标签
  createTag(data) {
    return api.post('asset_management/tags/', data);
  },

  // 删除资产标签
  deleteTag(id) {
    return api.delete(`asset_management/tags/${id}/`);
  },

  // 更新资产标签
  updateTag(id, data) {
    return api.put(`asset_management/tags/${id}/`, data);
  },

  // 为资产添加标签
  addTagToAsset(assetId, tagId) {
    return api.post(`asset_management/assets/${assetId}/add-tag/${tagId}/`);
  },

  // 从资产移除标签
  removeTagFromAsset(assetId, tagId) {
    return api.post(`asset_management/assets/${assetId}/remove-tag/${tagId}/`);
  },
  ...
  // 创建资产分组
  createGroup(data) {
    return api.post('asset_management/groups/', data);
  },

  // 删除资产分组
  deleteGroup(id) {
    return api.delete(`asset_management/groups/${id}/`);
  },

  // 更新资产分组
  updateGroup(id, data) {
    return api.put(`asset_management/groups/${id}/`, data);
  },

  // 将资产添加到分组
  addAssetToGroup(assetId, groupId) {
    return api.post(`asset_management/assets/${assetId}/add-to-group/${groupId}/`);
  },

  // 从分组移除资产
  removeAssetFromGroup(assetId, groupId) {
    return api.post(`asset_management/assets/${assetId}/remove-from-group/${groupId}/`);
  },
...
export {
  ...
  rulesAPI,
  settingsAPI,
  assetAPI  // 确保 assetAPI 被包含在导出列表中
};